<script setup name="ProductUnit">
    import {listProductUnit,addProductUnit,getProductUnit,updateProductUnit,delProductUnit} from "@/api/base/productUnit.js"
...
<template>
    <div class="app-container">
        ...
        <el-table :data="productUnitList" v-loading="loading" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="操作" class-name="small-padding fixed-width" width="200" align="center">
        ...
        <el-dialog :title="title" v-model="open" width="500px" append-to-body>
            ...
            <template #footer>
                <div class="dialog-footer">
                    ...
                    <el-button @click="canael">取消</el-button>
                </div>
            </template>
        </el-dialog>
